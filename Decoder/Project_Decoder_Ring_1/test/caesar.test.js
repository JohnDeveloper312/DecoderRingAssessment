...
describe("caesarModule()", () => {
    ...
    it("should return correctly encrypted letters when econced = true", () =>{
    ...
    it("should return correctly decrytped letters when encoded = false",() =>{
        const actual = caesar('bcde', 1, false)
        const expected = 'abcd'
        expect(actual).to.equal(expected)
    })
    it("should return correct encryption even when shift exceeds alphabet limit", () => {
